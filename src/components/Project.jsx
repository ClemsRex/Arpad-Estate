...
const Project = () => {
  ...
  // Functionality code for Project section slider button and for the Project section
  ...
  return (
    ...
    //Project Section Header and paragraph 
    ...
    className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects' >
      ...
      <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto '>Exclusive Listing, Unmatched Expertise-Explore our Porfolio</p>

      {/* Project section slider buttons */}
      ...
      <div className='overflow-hidden'>
        ...
        {/* Project section image, title, price, and location */}


          {projectsData.map((project, index)=>(
            <div key={index} className='relative shrink-0 w-full sm:w-1/4'>
              <img className='w-70 h-70 mb-10' src={project.image} alt={project.title} />
              <div className='absolute left-2 right-2 bottom-2 flex justify-center'>
 
                <div className='inline-block bg-white w-4/4 px-2 py-0 shadow-md'>
