...
const Testimonials = () => {
  ...
  return (
    ...
    // Testimonial Section Header and paragraph 
    ...
    className='container mx-auto py-10 lg:px-32 w-full overflow-hidden' id='Testimonials'>
      ...
      <p className='text-center text-gray-500 mb-12 max-w-80 mx-auto'>Review from Those Who Found a Home with Us </p>

      {/* Testimonial section image, name, title and rating  */}

      <div className='flex flex-wrap justify-center gap-8'>

        {testimonialsData.map((testimonial, index)=>(
          <div key={index} className='max-w-[320px] shadow-lg rounded px-8 py-12 text-center'>
